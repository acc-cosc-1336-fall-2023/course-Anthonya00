...
def option_1_selected():
    ...
    while num < 1 or num > 9:
        while True:
            try:
                num = int(input("Enter an number 1-9: "))
                break
            except ValueError:
                print("That isn't a number, Input a Number 1-9: ")
...
def option_2_selected():
    ...
    while num < 1 or num > 99:
        while True:
            try:
                num = int(input("Enter an number 1-99: "))
                break
            except ValueError:
                print("That isn't a number, Input a Number 1-99: ")
